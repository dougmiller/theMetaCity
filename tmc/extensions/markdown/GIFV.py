    ...
    def run(self, lines) -> list[str]:
        ...
        for line in lines:
            ...
            if match:
                ...
                video = etree.Element("video", {"autoplay": "true", "loop": "true", "muted": "true", "playsinline": "true", "class": self.css_class})

                for ext in extensions:
                    etree.SubElement(video, "source", {"src": f"{self.video_url_base}{filename}.{ext.strip()}"})
